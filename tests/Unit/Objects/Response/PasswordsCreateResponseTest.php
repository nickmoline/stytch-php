...
use Stytch\Objects\Response\PasswordsCreateResponse;
use Stytch\Objects\User;

class PasswordsCreateResponseTest extends TestCase
{
    public function testConstructor(): void
    {
        $response = new PasswordsCreateResponse(
            'test_request_id',
            200,
            'user_123',
            'session_token_456',
    ...
    public function testFromArray(): void
    {
        ...
        $response = PasswordsCreateResponse::fromArray($data);
    ...
    public function testRoundTripConversion(): void
    {
        ...
        $response = PasswordsCreateResponse::fromArray($originalData);
