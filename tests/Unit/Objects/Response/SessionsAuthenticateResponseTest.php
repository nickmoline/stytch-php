...
use Stytch\Objects\Response\SessionsAuthenticateResponse;
use Stytch\Objects\User;

class SessionsAuthenticateResponseTest extends TestCase
{
    public function testConstructor(): void
    {
        $response = new SessionsAuthenticateResponse(
            'test_request_id',
            200,
            'user_123',
            'session_token_456',
    ...
    public function testFromArray(): void
    {
        ...
        $response = SessionsAuthenticateResponse::fromArray($data);
    ...
    public function testRoundTripConversion(): void
    {
        ...
        $response = SessionsAuthenticateResponse::fromArray($originalData);
