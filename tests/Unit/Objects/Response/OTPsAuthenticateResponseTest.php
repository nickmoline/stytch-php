...
use Stytch\Objects\Response\OTPsAuthenticateResponse;
use Stytch\Objects\User;

class OTPsAuthenticateResponseTest extends TestCase
{
    public function testConstructor(): void
    {
        $response = new OTPsAuthenticateResponse(
            'test_request_id',
            200,
            'user_123',
            'session_token_456',
    ...
    public function testFromArray(): void
    {
        ...
        $response = OTPsAuthenticateResponse::fromArray($data);
    ...
    public function testRoundTripConversion(): void
    {
        ...
        $response = OTPsAuthenticateResponse::fromArray($originalData);
