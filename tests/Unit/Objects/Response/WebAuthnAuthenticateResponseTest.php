...
use Stytch\Objects\Response\WebAuthnAuthenticateResponse;
use Stytch\Objects\User;

class WebAuthnAuthenticateResponseTest extends TestCase
{
    public function testConstructor(): void
    {
        $response = new WebAuthnAuthenticateResponse(
            'test_request_id',
            200,
            'user_123',
            'session_token_456',
    ...
    public function testFromArray(): void
    {
        ...
        $response = WebAuthnAuthenticateResponse::fromArray($data);
    ...
    public function testRoundTripConversion(): void
    {
        ...
        $response = WebAuthnAuthenticateResponse::fromArray($originalData);
