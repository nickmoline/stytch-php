...
use Stytch\Objects\Response\TOTPsAuthenticateResponse;
use Stytch\Objects\User;

class TOTPsAuthenticateResponseTest extends TestCase
{
    public function testConstructor(): void
    {
        $response = new TOTPsAuthenticateResponse(
            'test_request_id',
            200,
            'user_123',
            'session_token_456',
    ...
    public function testFromArray(): void
    {
        ...
        $response = TOTPsAuthenticateResponse::fromArray($data);
    ...
    public function testRoundTripConversion(): void
    {
        ...
        $response = TOTPsAuthenticateResponse::fromArray($originalData);
