...
use Stytch\Objects\Response\MagicLinksAuthenticateResponse;
use Stytch\Objects\User;

class MagicLinksAuthenticateResponseTest extends TestCase
{
    public function testConstructor(): void
    {
        $response = new MagicLinksAuthenticateResponse(
            'test_request_id',
            200,
            'user_123',
            'session_token_456',
    ...
    public function testFromArray(): void
    {
        ...
        $response = MagicLinksAuthenticateResponse::fromArray($data);
    ...
    public function testRoundTripConversion(): void
    {
        ...
        $response = MagicLinksAuthenticateResponse::fromArray($originalData);
