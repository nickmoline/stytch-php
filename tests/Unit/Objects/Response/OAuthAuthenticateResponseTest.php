...
use Stytch\Objects\Response\OAuthAuthenticateResponse;
use Stytch\Objects\User;

class OAuthAuthenticateResponseTest extends TestCase
{
    public function testConstructor(): void
    {
        $response = new OAuthAuthenticateResponse(
            'test_request_id',
            200,
            'user_123',
            'session_token_456',
    ...
    public function testFromArray(): void
    {
        ...
        $response = OAuthAuthenticateResponse::fromArray($data);
    ...
    public function testRoundTripConversion(): void
    {
        ...
        $response = OAuthAuthenticateResponse::fromArray($originalData);
