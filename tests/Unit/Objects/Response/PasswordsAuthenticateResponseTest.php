...
use Stytch\Objects\Response\PasswordsAuthenticateResponse;
use Stytch\Objects\User;

class PasswordsAuthenticateResponseTest extends TestCase
{
    public function testConstructor(): void
    {
        $response = new PasswordsAuthenticateResponse(
            'test_request_id',
            200,
            'user_123',
            'session_token_456',
    ...
    public function testFromArray(): void
    {
        ...
        $response = PasswordsAuthenticateResponse::fromArray($data);
    ...
    public function testRoundTripConversion(): void
    {
        ...
        $response = PasswordsAuthenticateResponse::fromArray($originalData);
